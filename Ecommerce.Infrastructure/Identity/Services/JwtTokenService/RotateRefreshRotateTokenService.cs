...
public class RotateRefreshRotateTokenService(
    IRefreshTokenServiceHelper iRefreshTokenServiceHelper,
    IIpAdressService ipAdressService,
    IGenerateTokenService generateTokenService,
    UserManager<ApplicationUser> userManager,
    ApplicationDbContext dbContext,
    ILogger<RotateRefreshRotateTokenService> logger,
    IOptions<JwtSettings> jwtSettings) : IRefreshRotateTokenService
{
    public async Task<ResponseType<TokenResponseDto>> RefreshTokenAsync(RefreshTokenRequestDto request)
    {
        ...
        var isValid = await iRefreshTokenServiceHelper.IsRefreshTokenValidAsync(request.RefreshToken);
        if (!isValid)
        {
        ...
        var validationResult = await iRefreshTokenServiceHelper
        ...
        var rotationToken = await iRefreshTokenServiceHelper
        ...
        var claims = generateTokenService.BuildClaims(tokenUser);
        var newAccessToken = generateTokenService.CreateJwtToken(claims);
