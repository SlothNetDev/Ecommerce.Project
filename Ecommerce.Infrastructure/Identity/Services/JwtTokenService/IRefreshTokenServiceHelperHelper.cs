...
public class IRefreshTokenServiceHelperHelper(ApplicationDbContext dbContext,
    ILogger<IRefreshTokenServiceHelperHelper> logger,
    IIpAdressService ipAddressService,
    IOptions<JwtSettings> jwtSettings) :IRefreshTokenServiceHelper
{
